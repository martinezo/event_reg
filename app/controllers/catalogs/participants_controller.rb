  ...
  private
    ...
    def catalogs_participant_params
      params.require(:catalogs_participant).permit(:course_id, :name, :surnames, :mail, :phone_numbers, :workplace,
                                                   :bachelor_deg, :master_deg, :phd_deg, :inv_name, :inv_rfc, :inv_address,
                                                   :inv_city, :inv_municipality, :inv_state, :inv_mail, :text_opt,
                                                   :str_op1, :opt_str1, :opt_str2, :opt_bol1, :opt_bol2, :opt_sel,
                                                   :confirmed, :price, :upload_file1, :upload_file2, :upload_file3)
    end
